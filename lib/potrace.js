...
var Potrace = (function() {
  ...
  Potrace.prototype.getSVG = function() {
    ...
    // When tracing an image on a white background, the illustration parts are "holes" (sign === '-')
    // and the background is a "fill" (sign === '+'). We only render the holes to get a clean
    // SVG of the illustration with a transparent background.
